...
const (
	daemonChildEnv    = "_AGNESCODE_DAEMON_CHILD"
	daemonSupervisorEnv = "_AGNESCODE_DAEMON_SUPERVISOR"
	daemonPortEnv     = "_AGNESCODE_DAEMON_PORT"
	daemonVerboseEnv  = "_AGNESCODE_DAEMON_VERBOSE"
	daemonSkipValEnv  = "_AGNESCODE_DAEMON_SKIP_VALIDATION"
...
var daemonStartCmd = &cobra.Command{
	Use:   "start",
	Short: "启动守护进程",
	Long: "启动 AgnesCode Proxy 守护进程。Supervisor 进程监控子进程，" +
